# kb file named kb/hacking/tricks/exploit-asterisk-with-touch.md

- concept of `kb file named kb/hacking/tricks/exploit-asterisk-with-touch.md`

```
```

` zet/20221014185539/README.md `
