# DNS commands and lookup hub

- resolve a single individual subdomain by adding to `/etc/hosts`
- resolve domains with nameserver by adding to `/etc/resolv.conf`
```
nameserver 1.2.3.4
```
...
- [20221003151195](/zet/20221003151195/README.md) pentesting DNS to try list
