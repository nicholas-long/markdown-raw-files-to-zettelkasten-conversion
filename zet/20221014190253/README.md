# kb file named kb/bash-scripting/find-common-lines-set-operations.md

- concept of `kb file named kb/bash-scripting/find-common-lines-set-operations.md`

```
```

` zet/20221014190253/README.md `
