...
- read the manual
- zet project on github is rob's zettelkasten
- KEG project "knowledge exchange graph" to index and import zettelkasten-like graphs
  - discussed and shared on twitch streams
