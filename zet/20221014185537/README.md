# kb file named kb/hacking/tricks/ping-subnet-os-enumeration.md

- concept of `kb file named kb/hacking/tricks/ping-subnet-os-enumeration.md`

```
```

` zet/20221014185537/README.md `
